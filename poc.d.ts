export namespace Temporal {
  ...
  export type LocalDateTimeAssignmentOptions = Partial<OverflowOptions> &
    Partial<Temporal.ToAbsoluteOptions> &
    Partial<TimeZoneOffsetDisambiguationOptions>;
  export type LocalDateTimeMathOptions = Partial<DurationKindOptions> &
    Partial<Temporal.ToAbsoluteOptions> &
  ...
  export class LocalDateTime {
     ...
     * Available options:
     * ```
     * disambiguation?: 'earlier' (default) | 'later' | 'reject'
     ...
     *   `.getDate().difference(other.getDate())`.
     * - To calculate with clock times only, use
     *   `.getTime().difference(other.getTime())`.
     *
