...
function NormalizedDurationSign({ years, months, weeks, days, norm }) {
...
function AddDateTime(
  ...
  dateDuration = { ...dateDuration, days: dateDuration.days + timeResult.deltaDays };
...
export function AddZonedDateTime(epochNs, timeZone, calendar, { norm, ...dateDuration }, overflow = 'constrain') {
