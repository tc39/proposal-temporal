...
import { HOUR, MINUTE, SECOND, MILLISECOND, MICROSECOND, NANOSECOND, CreateSlots, GetSlot, SetSlot, HasSlot } from './slots.mjs';
...
export class Time {
  ...
  get hour() {
    if (!HasSlot(this, HOUR, MINUTE, SECOND, MILLISECOND, MICROSECOND, NANOSECOND)) throw new TypeError('invalid receiver');
