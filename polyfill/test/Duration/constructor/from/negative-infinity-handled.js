...
assert.throws(RangeError, () => Temporal.Duration.from({ weeks: -Infinity }, { disambiguation: 'constrain' }));
...
assert.throws(RangeError, () => Temporal.Duration.from({ weeks: obj }, { disambiguation: 'constrain' }));
