...
assert.throws(RangeError, () => instance.minus({ nanoseconds: Number.MAX_VALUE }));
assert.sameValue(called, 1);

assert.throws(RangeError, () => instance.minus({ nanoseconds: Number.MAX_VALUE }, { overflow: "balance" }));
assert.sameValue(called, 1);
