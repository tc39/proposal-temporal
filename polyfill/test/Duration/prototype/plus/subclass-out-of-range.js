...
assert.throws(RangeError, () => instance.plus({ nanoseconds: Number.MAX_VALUE }));
assert.sameValue(called, 1);

assert.throws(RangeError, () => instance.plus({ nanoseconds: Number.MAX_VALUE }, { overflow: "balance" }));
assert.sameValue(called, 1);
