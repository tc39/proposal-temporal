...
/*---
esid: sec-get-temporal.instant-@@species
info: |
...
const descriptor = Object.getOwnPropertyDescriptor(Temporal.Instant, Symbol.species);
assert.sameValue(typeof descriptor, "object", "Symbol.species descriptor should exist");
assert.sameValue(typeof descriptor.get, "function");
assert.sameValue(descriptor.set, undefined);

verifyProperty(Temporal.Instant, Symbol.species, {
  enumerable: false,
  configurable: true,
});
