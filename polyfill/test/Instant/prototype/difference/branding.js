...
const difference = Temporal.Instant.prototype.difference;
...
assert.throws(TypeError, () => difference.call(Temporal.Instant), "Temporal.Instant");
assert.throws(TypeError, () => difference.call(Temporal.Instant.prototype), "Temporal.Instant.prototype");
