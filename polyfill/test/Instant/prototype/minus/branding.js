...
const minus = Temporal.Instant.prototype.minus;
...
assert.throws(TypeError, () => minus.call(Temporal.Instant), "Temporal.Instant");
assert.throws(TypeError, () => minus.call(Temporal.Instant.prototype), "Temporal.Instant.prototype");
