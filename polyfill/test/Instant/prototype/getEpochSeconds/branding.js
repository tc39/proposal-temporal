...
const getEpochSeconds = Temporal.Instant.prototype.getEpochSeconds;
...
assert.throws(TypeError, () => getEpochSeconds.call(Temporal.Instant), "Temporal.Instant");
assert.throws(TypeError, () => getEpochSeconds.call(Temporal.Instant.prototype), "Temporal.Instant.prototype");
