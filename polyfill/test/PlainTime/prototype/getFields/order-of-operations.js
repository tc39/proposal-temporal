...
/*---
esid: sec-temporal.plaintime.prototype.getfields
...
function createGetter(key) {
  return {
    get() {
      actual.push(`get ${key}`);
      const result = Reflect.get(Temporal.PlainTime.prototype, key, this);
...
class ObservedTime extends Temporal.PlainTime {}
