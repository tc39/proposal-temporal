import { abbrevs, getProgressBar, makeTimeCases, temporalImpl as T, time, withSnapshotsFromFile } from './support.mjs';
...
// 1 ns as a rounding increment is already covered in timedifference.mjs
...
await time(async (start) => {
  ...
  await withSnapshotsFromFile('./timedifferencerounding.snapshot.json', (_, matchSnapshotOrOutOfRange) => {
