import { abbrevs, getProgressBar, makeDateCases, temporalImpl as T, time, withSnapshotsFromFile } from './support.mjs';
...
// 1 day as a rounding increment is already covered in datedifference.mjs
...
await time(async (start) => {
  ...
  await withSnapshotsFromFile('./datedifferencerounding.snapshot.json', (_, matchSnapshotOrOutOfRange) => {
