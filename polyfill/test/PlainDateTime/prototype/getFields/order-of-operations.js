...
/*---
esid: sec-temporal.plaindatetime.prototype.getfields
...
function createGetter(key) {
  return {
    get() {
      actual.push(`get ${key}`);
      const result = Reflect.get(Temporal.PlainDateTime.prototype, key, this);
...
class ObservedDateTime extends Temporal.PlainDateTime {}
