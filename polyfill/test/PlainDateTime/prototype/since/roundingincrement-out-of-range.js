...
assert.throws(RangeError, () => later.since(earlier, { roundingIncrement: -Infinity, smallestUnit: "year" }));
assert.throws(RangeError, () => later.since(earlier, { roundingIncrement: -1, smallestUnit: "year" }));
assert.throws(RangeError, () => later.since(earlier, { roundingIncrement: 0, smallestUnit: "year" }));
assert.throws(RangeError, () => later.since(earlier, { roundingIncrement: Infinity, smallestUnit: "year" }));
