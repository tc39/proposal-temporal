...
const equals = Temporal.YearMonth.prototype.equals;
...
assert.throws(TypeError, () => equals.call(Temporal.YearMonth), "Temporal.YearMonth");
assert.throws(TypeError, () => equals.call(Temporal.YearMonth.prototype), "Temporal.YearMonth.prototype");
