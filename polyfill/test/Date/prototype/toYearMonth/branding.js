...
assert.throws(TypeError, () => toYearMonth.call(Temporal.Date), "Temporal.Date");
assert.throws(TypeError, () => toYearMonth.call(Temporal.Date.prototype), "Temporal.Date.prototype");
