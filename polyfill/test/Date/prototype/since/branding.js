...
const since = Temporal.Date.prototype.since;
...
assert.throws(TypeError, () => since.call(Temporal.Date), "Temporal.Date");
assert.throws(TypeError, () => since.call(Temporal.Date.prototype), "Temporal.Date.prototype");
