...
const inLeapYear = Object.getOwnPropertyDescriptor(Temporal.Date.prototype, "inLeapYear").get;
...
assert.throws(TypeError, () => inLeapYear.call(Temporal.Date), "Temporal.Date");
assert.throws(TypeError, () => inLeapYear.call(Temporal.Date.prototype), "Temporal.Date.prototype");
