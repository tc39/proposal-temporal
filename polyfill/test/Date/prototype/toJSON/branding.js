...
const toJSON = Temporal.Date.prototype.toJSON;
...
assert.throws(TypeError, () => toJSON.call(Temporal.Date), "Temporal.Date");
assert.throws(TypeError, () => toJSON.call(Temporal.Date.prototype), "Temporal.Date.prototype");
