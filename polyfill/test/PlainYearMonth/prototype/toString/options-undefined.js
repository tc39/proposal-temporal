...
assert.sameValue(explicit, "2000-05-01[c=custom]", "default show-calendar option is auto");

const implicit = yearmonth.toString();
assert.sameValue(implicit, "2000-05-01[c=custom]", "default show-calendar option is auto");
