...
describe('fromString regex', () => {
  describe('absolute', () => {
    ...
    // 24:00 to mean next day midnight
    [
      '1976-11-18T24Z',
      '1976-11-18T24:00Z',
      '1976-11-18T24:00:00Z',
      '1976-11-18T24:00:00.0Z',
      '1976-11-18T24:00:00.000000000Z',
      '1976-11-18T240000.0Z'
    ].forEach((str) => test(str, [1976, 11, 19]));
    test('1976-11-18T24:00+01:00[Europe/Vienna]', [1976, 11, 18, 23]);
    test('1976-11-18T24:00-04:00', [1976, 11, 19, 4]);
  ...
  describe('datetime', () => {
    ...
    [
      ...
      '1976-11-18T24:00:00',
      '1976-11-18T24:00:00Z',
      '1976-11-18T24:00:00.0',
      '1976-11-18T24:00:00.000000000',
      '1976-11-18T240000.0'
    ].forEach((str) => test(str, [1976, 11, 19]));
    // Representations with reduced precision
  ...
  describe('time', () => {
    ...
    ['24:00', '24:00:00', '24:00:00.0', '24:00:00.000000000', '240000'].forEach((str) => test(str, []));
  });
