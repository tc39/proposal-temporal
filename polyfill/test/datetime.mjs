...
describe('DateTime', () => {
  ...
  describe('DateTime.from() works', () => {
    ...
    it('24:00 to mean next day midnight', () => {
      equal(`${DateTime.from('1976-11-18T24:00:00Z')}`, '1976-11-19T00:00');
      equal(`${DateTime.from('1976-11-30T24:00:00Z')}`, '1976-12-01T00:00');
      equal(`${DateTime.from('1976-12-31T24:00:00Z')}`, '1977-01-01T00:00');
    });
    it('0 is the only number valid with 24 hours', () => {
      ...
      ].forEach((str) => throws(() => DateTime.from(str), RangeError));
    });
    it('optional parts', () => {
