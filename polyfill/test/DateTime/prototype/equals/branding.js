...
const equals = Temporal.DateTime.prototype.equals;
...
assert.throws(TypeError, () => equals.call(Temporal.DateTime), "Temporal.DateTime");
assert.throws(TypeError, () => equals.call(Temporal.DateTime.prototype), "Temporal.DateTime.prototype");
