...
const result2 = Temporal.Instant.from('2020-01-09T00:00Z').since(Temporal.Instant.from('2020-01-09T04:00Z'), {
  largestUnit: 'minutes'
});
...
const duration = Temporal.Instant.from('2020-04-01T13:00-07:00[America/Los_Angeles]').since(Temporal.now.instant());
